#!/bin/bash
#SBATCH --partition=parallel         # Use the l40s partition (CPU nodes)
#SBATCH --time=24:00:00             # Job time limit
#SBATCH --nodes=1             # Run on a single node
#SBATCH --ntasks-per-node=48     # Use 24 CPU cores
#SBATCH -A hlee308            
...
declare -a SAMPLES=(
    "HG01mRNA-dCas9_RHm_CGG_1"
    "HG01mRNA-dCas9_RHm_CGG_2"
    "HG01mRNA-dCas9_RHwt_CGG_1"
    "HG01mRNA-dCas9_RHwt_CGG_2"
)
